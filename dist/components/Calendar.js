...
var Calendar = (function(_PureComponent) {
  ...
  function Calendar(props, context) {
    ...
    var _this = _possibleConstructorReturn(
      this,
      (Calendar.__proto__ || Object.getPrototypeOf(Calendar)).call(this, props, context)
    );
  ...
  _createClass(Calendar, [
    ...
    },
    {
      ...
      value: function focusToDate(date) {
        ...
        var targetMonthIndex = (0, _differenceInCalendarMonths2.default)(
          date,
          props.minDate,
          this.dateOptions
        );
    ...
    },
    {
      ...
      value: function changeShownDate(value) {
        ...
        var newDate = (0, _min2.default)([
          (0, _max2.default)([modeMapper[mode](), minDate]),
          maxDate,
        ]);
    ...
    },
    {
      ...
      value: function handleScroll() {
        ...
        var isFocusedToDifferent = !(0, _isSameMonth2.default)(
          visibleMonth,
        ...
        return _react2.default.createElement(
          ...
          showMonthAndYearPickers
            ? _react2.default.createElement(
                ...
                _react2.default.createElement(
                  ...
                  _react2.default.createElement(
                    ...
                    getMonths(locale).map(function(month, i) {
                      return _react2.default.createElement('option', { key: i, value: i }, month);
                    })
                  )
                ),
            ...
            : _react2.default.createElement(
                'span',
                { className: styles.monthAndYearPickers },
                getMonths(locale)[focusedDate.getMonth()],
                ' ',
            ...
            ? _react2.default.createElement(
                ...
                _react2.default.createElement(
                  ...
                  _react2.default.createElement(_reactList2.default, {
                    length: (0, _differenceInCalendarMonths2.default)(
                      (0, _endOfMonth2.default)(maxDate),
                      (0, _addDays2.default)((0, _startOfMonth2.default)(minDate), -1),
                      this.dateOptions
                    ),
                    treshold: 500,
                    type: 'variable',
